    ...
    return (
        <>
            <div className="relative flex items-center border-b border-gray-100 p-6 max-2xl:py-5 max-md:fixed max-md:top-0 max-md:left-0 max-md:right-0 max-md:z-10 max-md:h-16 max-md:bg-gray-0 max-md:px-4 max-md:py-0">
                ...
                <button
                    type="button"
                    className="ml-auto max-w-[min(32rem,45vw)] truncate rounded-xl px-4 py-2 text-right text-[15px] font-medium tracking-[-0.01em] leading-6 text-gray-800 transition-colors hover:bg-gray-50 disabled:cursor-default disabled:hover:bg-transparent max-md:max-w-[45vw] max-md:px-2 max-md:text-[15px]"
