...
const GenerateImage = ({ image }: Props) => {
    ...
    return (
        <>
            <div
                className="relative w-83 cursor-pointer not-first:mt-2 max-md:w-full"
            ...
            >
                ...
                <div className="p-6 bg-gray-0 rounded-xl max-md:p-4">
                    ...
                    <div className="mt-3 max-md:text-body-sm">
                        Hi, can you generate an image of a golden retriever
                    ...
                    {actions.map((action, index) => (
                        ...
                        >
                            ...
                            >
                                ...
                                />
                                {action.isPro && (
                                    <div className="absolute top-0 -right-5.5 px-1.75 py-0.75 bg-primary-0 rounded-full border border-primary-300 text-body-xs text-primary-300 font-medium max-md:-right-1.5">
                                        Pro
                                    </div>
                                )}
                            </div>
                            <div className="mt-2 text-center text-gray-0 max-md:-mx-1 max-md:text-body-sm">
                                {action.title}
                            </div>
                        </button>
                    ))}
